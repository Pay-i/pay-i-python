...
pip install git+ssh://git@github.com/undefined/sdk.git
```
...
These methods return an [`APIResponse`](https://github.com/undefined/sdk/tree/main/src/payi/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/undefined/sdk/tree/main/src/payi/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
